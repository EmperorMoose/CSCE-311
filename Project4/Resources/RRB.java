...
public class RRB extends IflRRB
{
    ...
    */
    ...
    {
      ResourceCB grantableResource = getResource();

      int newAvail = (grantableResource.getAvailable() - getQuantity());
      grantableResource.setAvailable(newAvail);

      int newAlloc = (grantableResource.getAllocated(getThread()) + (getQuantity()));
      grantableResource.setAllocated(getThread(), newAlloc);
